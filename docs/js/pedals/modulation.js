...
export const MODULATIONS = [
  new ModulationPedal({
    ...
    whatChanges: "one new pair of tones, either side of the note",
  ...
  new ModulationPedal({
    ...
    whatChanges: "a broad comb of new tones, spread either side",
  ...
  new ModulationPedal({
    ...
    whatChanges: "a faint new pair, close either side of the note",
